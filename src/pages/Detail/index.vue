    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuInfoList='skuInfo'/>
          <!-- 小图列表 -->
          <ImageList :skuInfoList = 'skuInfo' />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" 
                  ...
                  @click="ChangeIsChecked(spuSaleValue,spuSaleAttr.spuSaleAttrValueList)"
                  v-for="(spuSaleValue, index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleValue.id" 
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="changeSkuNun">
  ...
  export default {
    ...
    methods: {
      ...
      async addShopcart(){
        //派发actions
        try {
          //点击加入购物车按钮，第一件事把数据带给服务器（发请求），通知服务器加入购物车
          //需要知道请求是否成功，成功则路由跳转，失败则提示用户
          await this.$store.dispatch('addOrUpdateShopCart',{skuId: this.$route.params.skuId,skuNum:this.skuNum})
          //
          //进行路由跳转，将产品的信息带给下一级路由，
          //一些简单的数据skuNum可以通过query来进行传参，
          //比较复杂的产品信息skuInfo通过会话存储（sessionStorage ）
